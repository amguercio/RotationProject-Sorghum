...
##Script to Number of Cortex Layers in Sorghum Roots of various genotypes under various conditions
...
W2_cortexplot<-ggplot(twoweekdata, mapping=aes(Soil, Number_of_Cortex_Layers)) +
  geom_boxplot(aes(fill=Striga)) +
  geom_point(position=position_dodge(width=0.75),aes(group=Striga)) +
  ggtitle("Number of Cortex Layers 2 Weeks after Transfer") +
  theme_gray() +
  labs(x = "Soil Type", y= "Number of Cortex Layers", fill = "") +
  facet_grid(Root_Portion~Genotype, scales="fixed")



jpeg("2W_Cortexfigure.jpg")
W2_cortexplot
dev.off()
...
W3_cortexplot<-ggplot(threeweekdata, mapping=aes(Soil, Number_of_Cortex_Layers)) +
  geom_boxplot(aes(fill=Striga)) +
  geom_point(position=position_dodge(width=0.75),aes(group=Striga)) +
  ggtitle("Number of Cortex Layers 3 Weeks after Transfer") +
  theme_gray() +
  labs(x = "Soil Type", y= "Number of Cortex Layers", fill = "") +
  facet_grid(Root_Portion~Genotype, scales="fixed")


jpeg("3W_Cortexfigure.jpg")
W3_cortexplot
dev.off()
